...
curl -k https://raw.githubusercontent.com/kevinmeziere/breeder/0.8.0/fifo_current_version.py > /zones/$VMUUID/root/etc/fifo_current_version.py
chmod +x /zones/$VMUUID/root/etc/fifo_current_version.py

curl -k https://raw.githubusercontent.com/kevinmeziere/breeder/0.8.0/fifo_motd > /zones/$VMUUID/root/etc/fifo_motd.sh
